...
<%@page import="com.pj.admin.beans.Role"%>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" class="table">
                            ...
                            <td valign="top">
                                <table width="100%" class="top" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <c:if test="${add}">
                                                <a style="float: right; margin: 0px 12px 0 0;" href="createRole.jsp">+添加角色</a>
                                            </c:if>
                        ...
                        <tr>
                            <td>
                                ...
                                <form style="margin-top: 12px;" action="<s:url action="FindRole" namespace="admin" />" method="post" name="find_role" target="I2">
                                    请输入角色名字:<input onfocus="this.select()" type="text" size="20" maxlength="100" name="roleName" value="${roleName}" />
                                    ...
                                    <c:when test="${not empty roles}">
                                        <table width="100%" cellspacing="0" cellpadding="5" id="result">
                                            <tr>
                                                ...
                                                <td class="gray_border">角色名</td>
                                                <td class="gray_border">角色标示</td>
                                                <td class="gray_border">角色等级</td>
                                                <td class="gray_border">拥有权限</td>
                                            ...
                                            <c:forEach var="each" items="${roles}">
                                                <tr>
                                                    <td class="gray_border"><input class="select" type="checkbox" name="id" value="${each.roleId}" /></td>
                                                    <td class="gray_border">${each.roleName}</td>
                                                    <td class="gray_border">${each.roleKey}</td>
                                                    <td class="gray_border">${each.roleLevel}</td>
                                                    <td class="gray_border">
                                                        <c:forEach varStatus="s" var="auth" items="${each.authorities}">
                                                    ...
                                                    <td class="gray_border">
                                                        <c:if test="${delete}">
                                                            <a class="delete_admin" aid="${each.roleId}" href="javascript:void(0)">删除</a>
                                                        </c:if>
                                                    </td>
                                                </tr>
                                            </c:forEach>
