                        ...
                        <tr>
                            <td>
                                ...
                                <form action="<s:url namespace="/admin" action="AddNewAdmin" />" target="I2" method="post" name="add_admin">
                                    <input type="hidden" value="" id="field_roles" name="roleList" />
                                    <table width="100%" border="0">
                                        <tr>
                                            <td class="btd" width="100">用户名：</td>
                                            <td class="btd"><input class="text" type="text" maxlength="20" size="20" name="admin.adminName" /> </td>
                                        </tr>
                                        <tr>
                                            <td class="btd" width="100">真实姓名：</td>
                                            <td class="btd"><input class="text" type="text" maxlength="20" size="20" name="admin.adminRealName" /> </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="btd">密码：</td>
                                            <td class="btd"><input class="text" type="password" maxlength="20" size="20" name="admin.password" /> </td>
                                        </tr>
                                        <tr>
